package com.weercisoft.ortnote.data.model
...
data class NoteDbModel(
    ...
    @ColumnInfo(name = "can_be_checked") val can_be_checked: Boolean,
    @ColumnInfo(name = "is_checked") val is_checked: Boolean = false,
    @ColumnInfo(name = "color_id") val color_id: Long,
    @ColumnInfo(name = "in_trash") val in_trash: Boolean,
) {
    companion object {
        ...
        val DEFAULT_NOTES = listOf(
            ...
            NoteDbModel(
                4,
                "Workout",
                "Running, push ups, pull ups, squats...",
                false,
                false,
                4,
                false
