...
import com.weercisoft.ortnote.routine.OrtNoteRoutine
import com.weercisoft.ortnote.routine.Screen
import com.weercisoft.ortnote.ui.theme.OrtNoteTheme
import com.weercisoft.ortnote.ui.theme.OrtNoteThemeSettings
...
private fun LightDarkThemeItem() {
    val darkTime = isSystemInDarkTheme()
    Row(
        modifier = Modifier
            .padding(8.dp)
    ) {
        ...
        Switch(
            checked = OrtNoteThemeSettings.isDarkThemeEnabled ,
            onCheckedChange = { OrtNoteThemeSettings.isDarkThemeEnabled = it },
            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            onClick = {
                OrtNoteRoutine.navigateTo(Screen.Notes)
                closeDrawerAction()
            }
        )
        ScreenNavigationButton(
            ...
            onClick = {
                OrtNoteRoutine.navigateTo(Screen.Trash)
                closeDrawerAction()
            }
        )
        LightDarkThemeItem()
